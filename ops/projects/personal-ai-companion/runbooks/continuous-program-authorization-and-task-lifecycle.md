...
in `ARCHITECTURE_TODO.md`; orders 8-9B are repeated here only as the immediate
dependency anchors for order 10. Repeating field work is new L3 work, not a
