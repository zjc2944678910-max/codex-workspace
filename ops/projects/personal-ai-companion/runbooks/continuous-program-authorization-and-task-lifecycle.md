...
in `ARCHITECTURE_TODO.md`; orders 8-10 are repeated here only as the immediate
dependency anchors for order 11. Repeating field work is new L3 work, not a
...
| 12 | `PAC-HEALTH-SOURCE-ABSTRACTION` (`next`) | L1 | Preserve the five canonical families and existing HealthKit behavior. | Adapter attribution/deduplication plus a Shortcut/webhook or manual-export fallback; no real health-data intake. |
