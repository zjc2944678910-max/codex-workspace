# ClaimFlow Ops Surface

This directory is the operator-facing surface for `claimflow`.

## Routing Evidence

- Project name: `ClaimFlow`
- Aliases: `claim-flow`
- Registry routing keywords: `claimflow`, `ClaimFlow`, `claim-flow`
- Main code: `projects/research/claimflow`
- Ops surface: `ops/projects/claimflow`
- State/data: `state/project-data/claimflow`
- Scratch: `scratch/projects/claimflow`
- Reports: `reports/`
- Runbooks: `runbooks/`
- Live host aliases: -
- Service names: -
...
- Current status: Registered research surface for `claimflow`. Day-to-day work is local/research unless a future task introduces live infrastructure evidence.
- Risk gate: L0/L1 local docs/code/research work by default; no live infrastructure is registered for this project.
- Common commands:
  - `node docs/workspace/find-project.mjs claimflow`
...
- Next useful work: Keep routing facts synced with the registry; add project-specific commands or runbooks when they become confirmed.
