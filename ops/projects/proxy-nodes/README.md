...
- Current status: Registered live infrastructure surface for `proxy-nodes`. Treat this README as routing and durable context, not proof of current live health; collect fresh L2 evidence before judging runtime state.
...
- Common commands:
  - `node docs/workspace/find-project.mjs proxy-nodes`
