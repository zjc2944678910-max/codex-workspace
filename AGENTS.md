...
This project is indexed by GitNexus as **codex-workspace** (2049 symbols, 2876 relationships, 66 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
