...
This project is indexed by GitNexus as **codex-workspace** (2805 symbols, 3883 relationships, 67 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
