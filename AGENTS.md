...
This project is indexed by GitNexus as **codex-workspace** (2233 symbols, 3105 relationships, 66 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
