...
This project is indexed by GitNexus as **codex-workspace** (2679 symbols, 3739 relationships, 66 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
