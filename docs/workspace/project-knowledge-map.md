...
| Personal AI Companion | `personal-ai-companion`, `stackchan-ai`, `stackchan-companion`, `ai-companion`, `StackChan`, `memory-service`, `长期记忆`, `个人AI伴侣`, `桌面AI伴侣` | L0/L1 local product; no live infra | Code: `projects/products/personal-ai-companion`; Ops: [`ops/projects/personal-ai-companion`](../../ops/projects/personal-ai-companion/README.md) | [`architecture-decisions-2026-07-04.md`](../../ops/projects/personal-ai-companion/manifests/architecture-decisions-2026-07-04.md); [`mvp-build-order.md`](../../ops/projects/personal-ai-companion/runbooks/mvp-build-order.md); not GitNexus indexed | Sub2API/Claude for memory architecture, privacy boundaries, iOS/StackChan/NAS design review, and companion UX/copy polish. Keep OpenClaw and Sub2API as references unless explicitly routed. |
