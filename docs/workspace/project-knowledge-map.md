...
| Code Representation Caching Research Workbench | `code-representation-caching`, `cache representation paper`, `code-as-image caching`, `代码表示缓存论文` | L0/L1 local research; no live infra | Code: `projects/research/code-representation-caching`; Ops: [`ops/projects/code-representation-caching`](../../ops/projects/code-representation-caching/README.md); not GitNexus indexed | Project README; research-gap draft; preflight and breakpoint-topology reports; pilot runner and protocol | Strong-model review may challenge research framing, protocol validity, or code/test risk; Codex owns edits, API-cost controls, and evidence interpretation. |
