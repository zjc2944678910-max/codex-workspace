...
function summarizePathForCheckpoint(relativePath) {
  ...
  if (normalized === "AGENTS.md" || normalized === "WORKER.md" || normalized === "CLAUDE.md" || normalized === "PROJECTS.md" || normalized === "MOC.md" || normalized === "DAILY.md" || normalized === "README.md" || normalized === "WORKSPACE_MAP.md") return "workspace";
