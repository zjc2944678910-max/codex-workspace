...
- [[WORKSPACE_MAP]] — 工作区结构地图
- [[workspace-decisions]] — 长期决策记录
- [[daily-workflow]] — 日常工作流
- [[harness-contract]] — harness 约定
- [[project-surfaces]] — 项目面与路由
...
- `CLAUDE.md` / `AGENTS.md` — workspace 策略真源
- `docs/runbooks/` · `docs/reports/` — 运维手册与报告

---
用法:笔记里打 `[[` 弹补全;点链接跳转;左侧图谱图标看全网。
姊妹仓 claude-workspace 也有同款 MOC。
